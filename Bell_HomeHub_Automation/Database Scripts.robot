...
MySQL Store Result
    ...
    #Method In Library    Test Name    Location of .bat file    Direction    Result TimeStamp    Throughput Multiplier
...
MySQL Backup
    ...
    #Method in Library    Remote Location to store DB Backup file    Backup Type    Backup Period (In Days)    Backup Action
    MySQL_Backup    /D:/BackUp/    Automatic    1    Start

MySQL Copy
    [Setup]    DBParams    ${var_dbhostname}    ${var_dbusername}    ${var_dbpassword}    # Get connection details for Database
    #Method in Library    Project Name    Test Case ID
    MySQL_Copy    My PROJECT    1
