...
Generate_TestCases_All
    ...
    ...    # 1    2.4    11    # 1518    ETH    W_N
    ...    # 5    # 7 6    1    40    short    generic_dut_1
    ...    # generic_dut_0    # 802.11ac    YES    0    #CreateTestCommand    LAT
    ...    # Auto    1    2.4    1    # 1518    ETH
    ...    # W_N    5    # 7    1    40    short
    ...    # generic_dut_1    generic_dut_0    # 802.11ac    YES    0    #CreateTestCommand
    ...    # RR    Auto    1    2.4    11    # 1518
    ...    # ETH    W_N    5    # 7 6    1    40
    ...    # short    generic_dut_1    generic_dut_0    # 802.11ac    YES    0
    ...    #CreateTestCommand    RR    Auto    1    2.4    1
    ...    # 1518    ETH    W_N    5    # 7    1
    ...    # 40    short    generic_dut_1    generic_dut_0    # 802.11ac    YES
    ...    # 0    #CreateTestCommand    MaxClient    Auto    0    2.4
